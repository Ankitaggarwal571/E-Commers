...
import { addProdctAction, getProductAction } from '../Store/ActionCreateors/ProductAction'
      ...
      <div className="container-fluid">
        <div className="row">
            ...
            <div className="col-lg-10 my-4">
                <h4 className='bg-primary text-center text-light'>Add Product</h4>
                <form className='p-2' onSubmit={postData}>
                    ...
                    <div className="row mb-2">
                        <div className="col-6 ">
                            ...
                            <input type="text" placeholder='Enter Color' name='color' className='form-control' onChange={getData} />
                        </div>
                        <div className="col-6 ">
                            <label htmlFor="size">Size</label>
                            <input type="text" placeholder='Enter Size' name='size' className='form-control' onChange={getData} />
                        </div>
                    </div>
                    <div className="row mb-2">
                        <div className="col-6 ">
                            <label htmlFor="baseprice">Base Price</label>
                            <input type="number" placeholder='Enter Base Price' name='baseprice' className='form-control' onChange={getData} />
                        </div>
                        <div className="col-6 ">
                            <label htmlFor="discount">Discount</label>
                            <input type="number" placeholder='Enter Discount' name='discount' className='form-control' onChange={getData} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col">
                    ...
                    <button type='submit' className='btn btn-primary w-100 my-3'> Add Product </button>
                </form>
            </div>
        </div>
      </div>
